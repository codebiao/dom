 ...
 * 网址: https://www.cnblogs.com/skyfsm/p/7411961.html
*/
...
Mat image_stitch::stitch_2(Mat img, Mat img2) {
	...
	//const char* imagename = "F://Desktop//1.png";//左
	//将QString类型的全局变量address_1转化成String类型
	...
	//sift特征检测
	Ptr<SiftFeatureDetector> siftdtc = SiftFeatureDetector::create();// 海塞矩阵阈值
